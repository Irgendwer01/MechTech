...
public class Keys {
    ...
    public Keys() {
        TESLA_COIL_MODE_SWITCH = EnumHelper.addEnum(KeyBind.class, "TESLA_COIL_MODE_SWITCH",
                new Class[] { String.class, IKeyConflictContext.class, int.class },
                "mechtech.key.tesla_coil.mode_switch", KeyConflictContext.IN_GAME, Keyboard.KEY_APOSTROPHE);
        AUTO_FEEDER_MODE_SWITCH = EnumHelper.addEnum(KeyBind.class, "AUTO_FEEDER_MODE_SWITCH",
                new Class[] { String.class, IKeyConflictContext.class, int.class },
