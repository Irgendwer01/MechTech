...
public class JEIMTPlugin implements IModPlugin {
    ...
    public void register(IModRegistry registry) {
        registry.addRecipes(
                ToroidBlock.getAll().stream().map((TorusBlockRecipeWrapper::new)).collect(Collectors.toList()),
                TORUS_RECIPES);
    ...
    public void onRuntimeAvailable(IJeiRuntime jeiRuntime) {
         ...
         * IFocus<ItemStack> focus = registry.createFocus(IFocus.Mode.OUTPUT,
         * GATileEntities.ADVANCED_FUSION_REACTOR.getStackForm());
