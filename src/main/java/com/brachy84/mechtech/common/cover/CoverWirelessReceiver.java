...
public class CoverWirelessReceiver extends CoverBase {
    ...
    public CoverWirelessReceiver(@NotNull CoverDefinition definition, @NotNull CoverableView coverableView,
    ...
    public void renderCover(@NotNull CCRenderState ccRenderState, @NotNull Matrix4 matrix4,
                            @NotNull IVertexOperation[] iVertexOperations, @NotNull Cuboid6 cuboid6,
                            @NotNull BlockRenderLayer blockRenderLayer) {
        ClientHandler.COVER_WIRELESS_RECEIVER.renderSided(getAttachedSide(), cuboid6, ccRenderState, iVertexOperations,
                matrix4);
    }
}
