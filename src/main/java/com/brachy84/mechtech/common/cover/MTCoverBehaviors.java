...
public class MTCoverBehaviors {
    ...
    public static void init() {
        registerBehavior(200, new ResourceLocation(MechTech.MODID, "wireless_receiver"), MTMetaItems.WIRELESS_RECEIVER,
                CoverWirelessReceiver::new);
    }

    public static void registerBehavior(int coverNetworkId, @NotNull ResourceLocation coverId,
                                        @NotNull MetaItem<?>.MetaValueItem placerItem,
