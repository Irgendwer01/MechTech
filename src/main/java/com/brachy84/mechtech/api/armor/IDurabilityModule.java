...
public interface IDurabilityModule {
     ...
     */
    default double damage(EntityLivingBase entityLivingBase, ItemStack modularArmorPiece, NBTTagCompound moduleData,
                          DamageSource damageSource, float damage, EntityEquipmentSlot entityEquipmentSlot) {
        damage *= 100;
